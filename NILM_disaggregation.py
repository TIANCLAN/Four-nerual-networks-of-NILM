...
for r in range(1, nilm["run"]+1):
    ...
    if nilm["training"]["save_best"] == 1:
        checkpoint_path = "../../data/NILM/{}/{}/{}/logs/model/House_{}/{}/{}".format(name, nilm["dataset"]["name"], nilm["model"], nilm["dataset"]["test"]["house"][0], time, r) +"/checkpoint.ckpt"
        ...
        checkpoint_path = "../../data/NILM/{}/{}/{}/logs/model/House_{}/{}/{}".format(name, nilm["dataset"]["name"], nilm["model"], nilm["dataset"]["test"]["house"][0], time, r) +"/cp-{epoch:04d}.ckpt"
        checkpoint_dir = os.path.dirname(checkpoint_path)
    ...
    if not os.path.exists("../../data/NILM/{}/{}/{}/logs/model/House_{}/{}".format(name, nilm["dataset"]["name"], nilm["model"], nilm["dataset"]["test"]["house"][0], time)):
        os.makedirs("../../data/NILM/{}/{}/{}/logs/model/House_{}/{}".format(name, nilm["dataset"]["name"], nilm["model"], nilm["dataset"]["test"]["house"][0], time))

    with open("../../data/NILM/{}/{}/{}/logs/model/House_{}/{}/config.txt".format(name, nilm["dataset"]["name"], nilm["model"], nilm["dataset"]["test"]["house"][0], time), "w") as outfile:
    ...
    if nilm["dataset"]["name"] == "ukdale":
        ...
        # Save history
        ###############################################################################
        np.save("../../data/NILM/{}/{}/{}/logs/model/House_{}/{}/{}/history.npy".format(name, nilm["dataset"]["name"], nilm["model"], nilm["dataset"]["test"]["house"][0], time, r), history.history)
