...
with open("../../data/NILM/{}/ukdale/{}/logs/model/House_{}/{}/config.txt".format(name, nilm["model"], nilm["dataset"]["test"]["house"][0], time)) as data_file:
    nilm = json.load(data_file)
    print(nilm)
...
for r in range(1, nilm["run"]+1):
    ...
    try:
        hist.append(np.load("../../data/NILM/{}/ukdale/{}/logs/model/House_{}/{}/{}/history.npy".format(name, nilm["model"], nilm["dataset"]["test"]["house"][0], time, r), allow_pickle=True))
    except:
        hist.append(np.load("../../data/NILM/{}/ukdale/{}/logs/model/House_{}/{}/{}/history_{}.npy".format(name, nilm["model"], nilm["dataset"]["test"]["house"][0], time, r, epochs), allow_pickle=True))
...
for r in range(1, nilm["run"]+1):
    ...
    for test_from in batch_int:
        ...
        if nilm["training"]["save_best"]:
            model.load_weights("../../data/NILM/{}/ukdale/{}/logs/model/House_{}/{}/{}/checkpoint.ckpt".format(name, nilm["model"], nilm["dataset"]["test"]["house"][0], time, r))
        else:
            model.load_weights("../../data/NILM/{}/ukdale/{}/logs/model/House_{}/{}/{}/cp-{epoch:04d}.ckpt".format(name, nilm["model"], nilm["dataset"]["test"]["house"][0], time, r, epoch=pos_val_min+1))
    ...
    if a.save_pred:
        np.save("../../data/NILM/{}/ukdale/{}/logs/model/House_{}/{}/pred_{}.npy".format(name, nilm["model"], nilm["dataset"]["test"]["house"][0], time, r), [x_total, y_total_pred, y_total_true])
